      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          {showPromoInput && !appliedPromo && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-900">Apply Promo Code</h3>
                <button
              ...
              <div className="flex space-x-3">
                ...
                <button
                  ...
                  className="bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
                >
                  {promoCodeLoading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {plans.map((plan) => {
            ...
            const hasDiscount = appliedPromo && discountedPrice < originalPrice;
                    ...
                    {hasDiscount ? (
                      <div className="space-y-1">
                        ...
                        <div className="text-green-600 text-sm font-medium">
                          Save ${(originalPrice - discountedPrice).toFixed(2)} with {appliedPromo.code}
                        </div>
                      </div>
                    ) : (
                      <span className="text-4xl font-bold text-gray-900">${originalPrice}</span>
                    )}
